...
public:
	...
	FORCEINLINE FOnLoadingScreenHidden& OnLoadingScreenHiddenDelegate() { return LoadingScreenHidden; }
...
protected:
	DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnLoadingScreenVisibilityDynamic, bool, bLoadingScreenVisible);
	UPROPERTY(BlueprintAssignable)
	FOnLoadingScreenVisibilityDynamic OnLoadingScreenVisibilityChangedDynamic;
...
private:
	...
	/** Delegate broadcast when the loading screen is shown */
	FOnLoadingScreenHidden LoadingScreenHidden;

	/** A reference to the loading screen widget we are displaying (if any) */
	TObjectPtr<class UCommonActivatableWidget> LoadingScreenInstance;
